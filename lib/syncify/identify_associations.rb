module Syncify
  class IdentifyAssociations < ActiveInteraction::Base
    ...
    attr_accessor :association_registry

    def execute
      @association_registry = Syncify::Association::Registry.new

      identify_associations

      association_registry.build_associations
    end
    ...
    def identify_associations
      klass.reflect_on_all_associations.
        ...
        association_registry << Syncify::Association::StandardAssociation.new(
          from_class: klass,
          to_class: association.klass,
          name: association.name,
          destination: association_registry.built_associations
        )
      end
    end
    ...
    # TODO: this is a duplicate of what's in Syncify::Association::Registry
